...
DPT.objects.processDirs(dirs=['sessioneye/array04','session01/array04'],\
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:430472795015:awsnotify --message "RS4JobDone"
