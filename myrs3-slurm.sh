...
DPT.objects.processDirs(dirs=['sessioneye/array03','session01/array03'],\
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:430472795015:awsnotify --message "RS3JobDone"
