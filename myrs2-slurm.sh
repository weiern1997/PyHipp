...
DPT.objects.processDirs(dirs=None, objtype=pyh.RPLSplit, channel=[*range(33,97)]); \
DPT.objects.processDirs(dirs=['sessioneye/array02','session01/array02'],\
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:430472795015:awsnotify --message "RS2JobDone"
